<template>
    <div class="flex relative items-center justify-center">
        ...
        <div class="flex flex-row rounded-full absolute text-xl bg-white px-6 py-1 font-bold text-secondary bottom-4 left-1/2 -translate-x-1/2 bg-white hover:cursor-pointer hover:text-secondary-light">
            <div class="btn-text">
                {{btnText}}
            </div>
